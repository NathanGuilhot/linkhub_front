  ...
  return (
    <>
      <div className="flex items-center mr-5 ml-5 p-3 rounded bg-white rounded-full sticky top-4 max-w-full">
        ...
        <button className={"cursor-pointer select-none flex place-content-center ml-3 mr-1 p-3 " + (props.inMenu ? "bg-green-800 rounded-full" : "bg-white")} onClick={props.action}>
